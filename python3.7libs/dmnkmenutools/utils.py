...
def is_obj_node(kwargs):
    return kwargs['node'].type().name() == "geo"
    
def is_sop_transform(kwargs):
    return kwargs['node'].type().name() == "xform"
...
def add_pivot_transform(kwargs):
    ...
    dmnk_pivot_folder = hou.FolderParmTemplate("dmnk_pivot_transform", "Pivot Transform")
    center_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'center')"
    ...
    xmax_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'xmax')"
    ...
    xmin_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'xmin')"
    ...
    ymax_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'ymax')"
    ...
    ymin_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'ymin')"
    ...
    zmax_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'zmax')"
    ...
    zmin_btn_callback = "import dmnkmenutools.utils as mu; mu.pivot_cb(kwargs, 'zmin')"
